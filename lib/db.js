...
function initializeSchema(db) {
  db.exec(`
    CREATE TABLE IF NOT EXISTS drugs (
      ...
      excretion TEXT,
      clearance TEXT,
      typical_dose_range TEXT,
      max_daily_dose TEXT,
      dose_adjustments TEXT,
      hepatotoxicity_risk TEXT DEFAULT 'unknown',
      nephrotoxicity_risk TEXT DEFAULT 'unknown',
      cardiotoxicity_risk TEXT DEFAULT 'unknown',
      neurotoxicity_risk TEXT DEFAULT 'unknown',
      hematotoxicity_risk TEXT DEFAULT 'unknown',
      ld50 TEXT,
    ...
    CREATE TABLE IF NOT EXISTS interactions (
      ...
      effect_on_drug1 TEXT,
      effect_on_drug2 TEXT,
